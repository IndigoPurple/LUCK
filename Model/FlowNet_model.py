...
class FlowNet_dilation(nn.Module):

    def __init__(self, in_ch ):
        super(FlowNet_dilation, self).__init__()
        ...
        if reduced_model == False:
        # flow unit
            self.conv1 = conv_activation(in_ch, 64, kernel_size = 7, stride = 2, padding = 6, dilation=2, activation = activation,init_type = init_type )
            self.conv2 = conv_activation(64, 128, kernel_size = 5, stride = 2, padding = 4, dilation=2 ,activation = activation,init_type = init_type )

            self.conv3 = conv_activation(128, 256, kernel_size = 5, stride = 2, padding = 4, dilation=2, activation = activation,init_type = init_type )
            self.conv3_1 = conv_activation(256, 256, kernel_size = 3, stride = 1, padding = 2, dilation=2, activation = activation,init_type = init_type )

            self.conv4 = conv_activation(256, 512, kernel_size = 3, stride = 2, padding = 2, dilation=2, activation = activation,init_type = init_type )
            self.conv4_1 = conv_activation(512, 512, kernel_size = 3, stride = 1, padding = 2, dilation=2, activation = activation,init_type = init_type )

            self.conv5 = conv_activation(512, 512, kernel_size = 3, stride = 2, padding = 2, dilation=2 ,activation = activation,init_type = init_type )
            self.conv5_1 = conv_activation(512, 512, kernel_size = 3, stride = 1, padding = 2, dilation=2 ,activation = activation,init_type = init_type )

            self.conv6 = conv_activation(512, 1024, kernel_size = 3, stride = 2, padding = 2, dilation=2 , activation = activation,init_type = init_type )
            self.conv6_1 = conv_activation(1024, 1024, kernel_size = 3, stride = 1, padding = 2, dilation=2 ,activation = activation,init_type = init_type )
...
class ABFlowNet(nn.Module):

    def __init__(self, in_ch):
        super(ABFlowNet, self).__init__()
        ...
        if reduced_model == False:
            ...
            # in_ch = 3 + 64 + 2 = 69
            self.concat0_conv1 = conv_activation(70, 16, kernel_size=7, stride=1, padding=3, activation='selu',
                                                 init_type='w_init')
