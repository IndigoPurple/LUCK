...
if __name__ == '__main__':
    ...
    dataloader_train = DataLoader(load_data(train_c_path,train_m_path,train_rgb_path,training=True), batch_size=opt['batch_size'], shuffle=True, num_workers=4, pin_memory=True,prefetch_factor=8) # num_workers=4
